...
export class CourseGenerationController {
   ...
   */
  static generateCourse = asyncHandler(async (req: Request, res: Response): Promise<void> => {
    ...
    if (!io) {
      throw new ValidationError('WebSocket server not available');
    }
   ...
   * Get session status
   */
  static getSessionStatus = asyncHandler(async (req: Request, res: Response): Promise<void> => {
   ...
   */
  static getAllSessions = asyncHandler(async (req: Request, res: Response): Promise<void> => {
   ...
   */
  static setupWebSocket = (io: SocketIOServer) => {
